<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wsAdminClientes.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<center>
    	<h3><asp:Label ID="Label1" runat="server" Text="Administración de Clientes:" CssClass="fontTrabajoTitulo" ></asp:Label></h3>
    	<br />
    <div class="">
         <table width="70%" border="0"> 
            ...
            <tr>
                <td align="left">
                    <asp:Label ID="Label5" runat="server" Text="Correo:" CssClass="fontTrabajoTitulo"></asp:Label>
                </td>
                <td align="left">
            ...
            <tr>
                <td align="left">
                    <asp:Label ID="Label6" runat="server" Text="Nombre:"  CssClass="fontTrabajoTitulo"></asp:Label>
                </td>
                <td align="left">
            ...
            <tr>
                <td align="left">
                    <asp:Label ID="Label7" runat="server" Text="Apellido parterno:" CssClass="fontTrabajoTitulo"></asp:Label>
                </td>
                <td align="left">
            ...
            <tr>
                <td align="left">
                    <asp:Label ID="Label4" runat="server" Text="Apellido materno:" CssClass="fontTrabajoTitulo"></asp:Label>
                </td>
                <td align="left">
